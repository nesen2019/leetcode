...
class HandleList:
    def __init__(self, data=None, is_data_two=True):
        ...
        >>> data_list = [1,2,3,4]
        >>> root = HandleList(data_list).data_root

        >>> root = HandleList([3,2,4,1]).data_root
        >>> data_list = HandleList(root).data_list
    ...
    def data_list(self):
        ...
        >>> h_list = HandleList([1,2,3,4])
        >>> root = h_list.data_root
        >>> new_h_list = HandleList(root)
        >>> new_h_list.data_list
        [1, 2, 3, 4]
        >>> HandleList(HandleList([3,2,4,1]).data_root).data_list
        [3, 2, 4, 1]
...
if __name__ == '__main__':
    ...
    doctest.testmod()
    # h_list = HandleList([1, 2, 3, 4])
    # print(h_list.data_two)
    # root = h_list.data_root
    # print(h_list.data_root)
    # print(h_list.data_list)
    # new_h_list = HandleList(data=root)
    # print(new_h_list.data_root)
    # print(new_h_list.data_list)
